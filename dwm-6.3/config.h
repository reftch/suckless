...
static const int titlebackground    = 1;        /* 0 means no title bar background */
static const int vertpad            = 5;        /* vertical padding of bar */
static const int sidepad            = 5;        /* horizontal padding of bar */
/*static const char *fonts[]          = { "monospace:size=10", "fontAwesome:size=10", "fa5:size=10:antialias=true:autohint=true" };*/
static const char *fonts[]          = { "monospace:size=10", "Symbols Nerd Font:size=10:antialias=true:autohint=true" };
...
static Key keys[] = {
    ...
    { 0,                            0x1008FF02,spawn,          SHCMD("brightnessctl set +5%; pkill -RTMIN+21 dwmblocks") },
    { 0,                            0x1008FF03,spawn,          SHCMD("brightnessctl set 5%-; pkill -RTMIN+21 dwmblocks") },
